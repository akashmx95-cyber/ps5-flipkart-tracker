...
@app.route('/')
def home():
    return "<h1>✅ PS5 Tracker (30 sec interval) is LIVE</h1>"
...
def background_checker():
    print("🚀 Background Checker Started (30 sec interval)")
    time.sleep(5)
    while True:
        check_stock()
...
if __name__ == "__main__":
    ...
    app.run(host='0.0.0.0', port=os.environ.get("PORT", 8080))import requests
from bs4 import BeautifulSoup
import time
from datetime import datetime
import os
